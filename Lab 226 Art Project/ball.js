...
this.checkEdges = function(){
  ...
  this.render = function(){
    stroke(255, 0, 0, 255);
    line(this.loc.x, this.loc.y, 0, 400);
    stroke(255, 155, 0, 255);
    line(this.loc.x, this.loc.y, 0, 0);
    stroke(255, 255, 0, 255);
    line(this.loc.x, this.loc.y, 1200, 800);
    stroke(102, 255, 102, 255);
    line(this.loc.x, this.loc.y, 1200, 0);
    stroke(0, 51, 102, 255);
    line(this.loc.x, this.loc.y, 1200, 400);
    stroke(204, 0, 255, 255);
